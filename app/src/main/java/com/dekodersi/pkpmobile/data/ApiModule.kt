...
class ApiModule {
    ...
    @Provides
    @Singleton
    internal fun provideEpisodeRepository(apiService: ApiService): SeatRepository {
        return SeatRepository(apiService)
    }

    @Provides
    @Singleton
    internal fun provideSeatViewModelFactory(repository: SeatRepository): SeatViewModelFactory {
        return SeatViewModelFactory(repository)
    }
